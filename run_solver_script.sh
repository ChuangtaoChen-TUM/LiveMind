...
python run_solver.py -i llama-3-70b -g clause -d mmlu_pro -f --log --no-hypo --no-sum -pf u-pi
python run_solver.py -i llama-3-70b -g clause -d mmlu_pro -f --log --no-hypo --no-sum -pf u-pli
python run_solver.py -i llama-3-70b -g clause -d mmlu_pro -f --log --no-hypo --no-sum -pf u-pil
python run_solver.py -i llama-3-70b -g clause -d mmlu_pro -f --log --no-hypo --no-sum -pf u-ip
python run_solver.py -i llama-3-70b -g clause -d mmlu_pro -f --log --no-hypo --no-sum -pf u-ipl
python run_solver.py -i llama-3-70b -g clause -d mmlu_pro -f --log --no-hypo --no-sum -pf ua-pil
python run_solver.py -i llama-3-70b -g clause -d mmlu_pro -f --log --no-hypo --no-sum -pf u-spi
python run_solver.py -i llama-3-70b -g clause -d mmlu_pro -f --log --no-hypo --no-sum -pf ua-spi
