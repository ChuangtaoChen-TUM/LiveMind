...
class LMFormatter(BaseActionFormatter):
    ...
    def __init__(self, append_new: bool=False, include_wait: bool=False):
    ...
    def sys_formatter(self, action_types: Iterable[ActionType]) -> str:
        ...
        all_actions = "/".join([action_type.name for action_type in action_types])
    ...
    def final_sys_formatter(self, action_types: Iterable[ActionType]) -> str:
        ...
        """
        return ("You are a helpful AI assistant. Your are given a problem and previous inferences you have made about the problem. "+
...
class CoTFormatter(BaseActionFormatter):
    ...
    def sys_formatter(action_types: Iterable[ActionType]) -> str:
        """ Not implemented """
        raise NotImplementedError

    def final_sys_formatter(action_types: Iterable[ActionType]) -> str:
        """ Format the system prompt for final msg:
    ...
    def prompt_formatter(actions: list[Action], new_prompts: list[str]) -> str:
        """ Not implemented """
        raise NotImplementedError

    def final_prompt_formatter(actions: list[Action], new_prompts: list[str]) -> str:
        """ Format the user prompt based on the actions and the new prompts:
    ...
    def parse_action(response: str, action_types: Iterable[ActionType]) -> Action|None:
        """ Not implemented """
        raise NotImplementedError
